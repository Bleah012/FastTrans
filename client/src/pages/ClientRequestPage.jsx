            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <h2 className="mt-1 text-2xl font-bold">
                  Transport Request Receipt
                </h2>
                <p className="mt-1 text-slate-600">
                  The client request has been submitted and recorded by
                  FastTrans.
                </p>
              </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-md bg-slate-50 p-4">
                ...
                <p className="mt-1 font-semibold">
                  {submittedRequest.pickupLocation} to{" "}
              ...
              <div className="rounded-md bg-slate-50 p-4">
                ...
                <p className="mt-1 font-semibold">
                  {submittedRequest.packageType} • {submittedRequest.weight} kg
                </p>
              </div>
              ...
              <div className="rounded-md bg-slate-50 p-4">
                ...
                <p className="mt-1 font-semibold">
                  {submittedRequest.pickupDate} at {submittedRequest.pickupTime}
                </p>
              </div>
              ...
              <div className="rounded-md bg-slate-50 p-4 md:col-span-2">
                ...
                <p className="mt-1 font-semibold">
                  {submittedRequest.instructions || "No instructions provided."}
                </p>
              </div>
            </div>
